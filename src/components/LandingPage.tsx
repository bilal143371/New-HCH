...
// Custom Premium Medical-Grade SVG Icons colored in Forest Green and Terracotta
const SVGIconNutrition = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM13 17H11V15H13V17ZM13 13H11V7H13V13Z" fill="#2F5233"/>
    <path d="M8.5 10.5C9.32843 10.5 10 9.82843 10 9C10 8.17157 9.32843 7.5 8.5 7.5C7.67157 7.5 7 8.17157 7 9C7 9.82843 7.67157 10.5 8.5 10.5Z" fill="#F2865E"/>
    <path d="M15.5 10.5C16.3284 10.5 17 9.82843 17 9C17 8.17157 16.3284 7.5 15.5 7.5C14.6716 7.5 14 8.17157 14 9C14 9.82843 14.6716 10.5 15.5 10.5Z" fill="#F2865E"/>
  </svg>
);

const SVGIconFitness = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M20.57 14.86L22 13.43L20.57 12L17 15.57L8.43 7L12 3.43L10.57 2L9.14 3.43L7.71 2L5.57 4.14L4.14 2.71L2.71 4.14L4.14 5.57L2 7.71L3.43 9.14L2 10.57L3.43 12L7 8.43L15.57 17L12 20.57L13.43 22L14.86 20.57L16.29 22L18.43 19.86L19.86 21.29L21.29 19.86L19.86 18.43L22 16.29L20.57 14.86Z" fill="#F2865E"/>
  </svg>
);

const SVGIconMind = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 3C7.5 3 3.7 6.4 3.1 10.8C2.3 11.2 1.8 12.1 1.8 13C1.8 14.1 2.5 14.9 3.5 15.1C3.8 18.9 7 21.9 11 21.9C15.8 21.9 19.8 18.2 20.2 13.5C21.2 13.1 21.8 12.1 21.8 11C21.8 9.6 20.5 8.4 19.1 8.8C18.1 5.4 15.3 3 12 3ZM12 5.5C14.2 5.5 16.1 7.1 16.8 9.3C15.4 9.1 14.1 9.8 13.5 11C12.9 12.2 13.1 13.7 14 14.6C13.5 15.8 12.3 16.5 11 16.5C9.3 16.5 8 15.2 8 13.5C8 12.5 8.5 11.6 9.3 11C8.2 10.4 7.5 9.3 7.5 8C7.5 6.6 8.6 5.5 10 5.5C10.7 5.5 11.4 5.8 11.9 6.3C12 6.3 12 6.3 12 6.3C12.1 6.3 12.1 6.3 12.2 6.3C12.6 5.8 13.3 5.5 14 5.5H12Z" fill="#2F5233"/>
    <circle cx="12" cy="11.5" r="2" fill="#F2865E"/>
  </svg>
);

const SVGIconReminders = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M17 12C17 14.76 14.76 17 12 17C9.24 17 7 14.76 7 12C7 9.24 9.24 7 12 7C14.76 7 17 9.24 17 12Z" fill="#2F5233"/>
    <path d="M12 2C6.5 2 2 6.5 2 12C2 17.5 6.5 22 12 22C17.5 22 22 17.5 22 12C22 6.5 17.5 2 12 2ZM12 20C7.6 20 4 16.4 4 12C4 7.6 7.6 4 12 4C16.4 4 20 7.6 20 12C20 16.4 16.4 20 12 20ZM12.5 7H11V13L16.2 16.2L17 15L12.5 12.3V7Z" fill="#F2865E"/>
  </svg>
);
